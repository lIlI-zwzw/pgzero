...
def getfont(**kwargs):
    ...
    if len(_font_cache) > MAX_FONT_CACHE_LENGTH:
        _font_cache_sorted_list = sorted(_font_cache,key=lambda x: x[1])
        for _ in range(20):
            del _font_cache_sorted_list[0]
